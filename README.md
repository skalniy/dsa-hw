...
### Анализ
**scripts/generator.py** предназначен для генерации больших объемов входных данных (создание хеш-таблицы, ее заполнение 2<sup>i</sup> ключами, затем 1000 случайных операций). Начальный размер таблицы равен 2<sup>i+4</sup>.
...
**scripts/test.py** (зависит от [matplotlib](https://matplotlib.org/)) анализирует время работы случайных операций из сгенерированных файлов и рисует графики зависимости времени выполнения от количества пар в таблице (файлы ***algname_opname.png***).
...
### **cuckoo**
Время любой операции равно _O(1)_
